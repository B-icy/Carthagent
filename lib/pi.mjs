...
export function locatePi(explicit) {
  ...
  // pi is a bundled dependency — prefer the vendored CLI so pi2 is self-contained.
  ...
  throw new Error('Cannot find the bundled pi CLI — run npm install, or pass --pi-cli /path/to/cli.js');
}
