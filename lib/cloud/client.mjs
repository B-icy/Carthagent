...
export function cloudManagedUsageRecovery(value) {
  ...
  if (/insufficient_quota|insufficient.credit|credit (?:is )?exhausted/i.test(text)) return 'Carthagent Cloud credit is exhausted. Use /billing checkout to add Builder credit or /login for BYOK.';
  return null;
}
