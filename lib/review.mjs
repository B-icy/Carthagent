 ...
 * and opens a PR; `ctg review <pr>` then runs a brand-new agent process with
 ...
 *  Undefined falls through to the built-in default (carthage theme, agent's
 ...
 */
export function reviewKickoff(ctgBin = CTG_BIN) {
...
2. Run: node "${ctgBin}" review <pr-number-or-url>
...
/** Prompt for the detached fresh-context reviewer subprocess (`ctg review <pr>`). */
