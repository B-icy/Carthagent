...
/** Requested loop limit; not a cross-process security boundary. */
...
4. Stop after at most ${MAX_REVIEW_ROUNDS} review rounds — this is a workflow instruction, not an enforced cross-process quota, so summarize any remaining findings for the user instead of looping forever.`;
}
