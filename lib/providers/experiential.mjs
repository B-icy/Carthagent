...
export function managedCloudRequestOptions(options = {}, id) {
  ...
  return {
    ...options,
    // The SDK builds the payload once and reuses these request-scoped headers
    // for every HTTP retry of this logical operation.
    requestHeaders: {
      ...inheritedHeaders,
    ...
    onPayload: async (payload, activeModel) => {
      ...
      return { ...body, metadata: { ...body.metadata, operation_key: operationKey } };
    },
  };
}
