...
import { authTypeLabel, applyAuthEvent, createCloudBillingLink, filterLoginProviders, formatCloudAccount, loadAuthRuntime, loadCloudAccount, loginAndRefresh, loginProviderFocus, loginProviderList, newAuthState, revokeCloudSession } from './auth.mjs';
...
export async function runTui(opts) {
  ...
  const openAuth = async ({ focusProviderId } = {}) => {
    ...
    try {
      ...
      a.sel = loginProviderFocus(a.providers, focusProviderId || activeProviderId);
