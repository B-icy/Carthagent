...
export async function runTui(opts) {
  ...
  const slash = v => {
    ...
    switch (cmd) {
      ...
      case '/help': push2(`${BOLD}keys${RESET}  enter send/steer · esc abort (again = force-restart pi) · ^r resume session · tab focus · ⇧tab view · pgup/pgdn/wheel scroll focused pane · drag-select copies · ^t settings · ^n new session · ^x expand · ^l clear · ^c quit
