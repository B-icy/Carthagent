  ...
  function stampAuth(lines, W, H) {
    ...
    if (a.phase === 'providers' || a.phase === 'type') {
      ...
      const hints = a.phase === 'type'
        ...
        : ' type to filter · ↑↓ select · enter connect · esc close ';
      card.push(row(fg(faint) + hints + RESET));
    } else {
      ...
      if (a.phase === 'prompt') {
        ...
        card.push(row(fg(faint) + (p.type === 'select' ? ' ↑↓ select · enter confirm · esc cancel ' : ' enter confirm · esc cancel ') + RESET));
      } else {
      ...
      if (a.phase === 'prompt') {
        ...
        if (p.type === 'select') {
          ...
          switch (k.key) {
            ...
            case 'paste': a.input += k.text; break;
          }
        }
        feed.version++;
        return;
